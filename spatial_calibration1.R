...
##Next, optimize NLL
optimization<-optim(c(1.3, -0.06), lfun,  sd=ind$sd, r=ind$error, method = "Nelder-Mead")
optimization

oparams<- optimization$par

a<-oparams[1] #best was ~0.4964
b<-oparams[2] #best was ~-0.00578
